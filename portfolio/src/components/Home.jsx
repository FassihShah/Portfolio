...
function CodeBlock() {
    return (
        <div className="font-mono text-sm text-gray-400 border border-gray-600 p-4 rounded-md bg-gray-900 backdrop-blur-sm w-full max-w-sm">
...
function Home() {
    return (
        <section
            id="home"
            className="bg-gray-900 min-h-screen flex items-center justify-center p-8 relative"
        >
            <SocialLinks />
